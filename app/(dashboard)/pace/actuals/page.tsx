    ...
    <div>
      ...
      {entities.length === 0 ? (
        <p className="text-[14px] text-muted">
          No entities yet. Add one under <a className="text-accent-700" href="/pace/entities">Entities</a> and import a trial balance.
        </p>
      ) : (
        <>
      ...
      <div className="mb-3 flex flex-wrap items-center gap-2">
        ...
        {statement.unmappedAmount !== 0 && (
          <span className="tag tag-outline">
            Unmapped: {formatCurrency(statement.unmappedAmount)} — resolve in <a className="text-accent-700" href="/pace/mapping">COA mapping</a>
          </span>
        )}
      </div>
